...
namespace SimpleWeb {
  ...
  public:
    ...
    public:
      ...
      /// Messages still waiting to be written. It grows without end for a client that stopped reading (a tablet asleep
      ...
      /// Drops the connection at once : the error and close handlers follow on the io thread.
