...
public:
	...
	double unitSteps;
	bool snapToUnitSteps; //with unitSteps > 0, values set on the parameter are rounded to that grid. Turn off to keep unitSteps for display and explicit snapping (getStepSnappedValueFor) only.
	int stringDecimals;
