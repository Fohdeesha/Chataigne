...
{
	//seconds as a double from the high resolution counter : a float of the 32-bit millisecond counter only resolved 31 ms
	//after 3 days of uptime, 250 ms after 24, and jumped back to 0 every 49.7 days
