...
public:
	...
	~ParameterNumberAutomation() { stopThread(1000); } //the thread reads automation, which dies before the base destructor runs
...
public:
	...
	~ParameterColorAutomation() { stopThread(1000); } //the thread reads colorManager, which dies before the base destructor runs
